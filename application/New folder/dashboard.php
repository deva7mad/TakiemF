...
<body>
   <nav>
    ...
    <div id="myModalSide" class="side-modal">
            <div class="modal-content-side" style="float:right; height:100%;">
                ...
                <div lang="ar" dir="rtl">
                    ...
                    <div class="panel">
                        <a class="side-link" href="edit-acc-info.php" style="color:#929090; float:right;  text-decoration: none; cursor:pointer; margin-right:45px; font-size:14px; font-family:'Cairo';">بيانات الحساب</a><br>
                        <a class="side-link" href="edit-school-info.php" style="color:#929090; float:right; text-decoration: none; cursor:pointer; margin-right:45px; font-size:14px; font-family:'Cairo';">بيانات المدرسة</a>
                    </div>
                 </div>
             <div lang="ar" dir="rtl">
            <a href="notifications.php"><button id="btn2" class="accordion1" lang="ar" dir="rtl"><i class="fas fa-bell" style="font-size:18px; margin-right: 25px;"></i><span style="margin-right:10px; font-size:16px; font-family:'Cairo';">التنبيهات</span></button></a>
            ...
            <button id="btn3" class="accordion" lang="ar" dir="rtl"><i class="fas fa-envelope" style="font-size:18px; margin-right: 25px;"></i><span style="margin-right:10px; font-size:16px; font-family:'Cairo';">الرسائل</span></button>
                <div class="panel">
                    <a class="side-link" href="message-inbox.php" style="color:#929090; float:right;  text-decoration: none; cursor:pointer; margin-right:45px; font-size:14px; font-family:'Cairo';">الرسائل الواردة</a><br>
                    <a class="side-link" href="mesaage-outbox.php" style="color:#929090; float:right; text-decoration: none; cursor:pointer; margin-right:45px; font-size:14px; font-family:'Cairo';">الرسائل الصادرة </a> <br>
                    <a class="side-link" href="ready-message.php" style="color:#929090; float:right; text-decoration: none; cursor:pointer; margin-right:45px; font-size:14px;font-family:'Cairo';">الرسائل الجاهزة</a>
                </div>
            </div>
            <div lang="ar" dir="rtl">
            ...
            <button id="btn1" class="accordion" lang="ar" dir="rtl"><i class="fas fa-users" style="font-size:18px; margin-right: 25px;"></i><span style="margin-right:10px; font-size:16px;font-family:'Cairo';">الفصول</span></button>
                <div class="panel">
                  <a id="side-link" href="#" style="color:#929090 float:right;  text-decoration: none; cursor:pointer; margin-right:45px; font-size:14px; font-family:'Cairo';">فصل أ</a><br>
                  <a class="side-link" href="#" style="color:#929090; float:right; text-decoration: none; cursor:pointer; margin-right:45px; font-size:14px; font-family:'Cairo';">فصل ب </a>
                </div>
            </div>
            <div lang="ar" dir="rtl">
            <button id="btn1" class="accordion" lang="ar" dir="rtl"><i class="fas fa-calendar-alt" style="font-size:18px; margin-right: 25px;"></i><span style="margin-right:10px; font-size:16px; font-family:'Cairo';">الخطط الاسبوعية</span></button>
                <div class="panel">
                  <a class="side-link" href="#" style="color:#929090; float:right;  text-decoration: none; cursor:pointer; margin-right:45px; font-size:14px;">خطة اسبوعية اولى </a><br>
                  <a class="side-link" href="#" style="color:#929090; float:right; text-decoration: none; cursor:pointer; margin-right:45px; font-size:14px;">خطة اسبوعية ثانية</a>
                </div>
            </div>
             <div lang="ar" dir="rtl">
            <button id="btn1" class="accordion" lang="ar" dir="rtl"><i class="fas fa-umbrella" style="font-size:18px; margin-right: 25px;"></i><span style="margin-right:10px; font-size:16px; font-family:'Cairo';">الاجازات</span></button>
                <div class="panel">
                  <a class="side-link" href="#" style="color:#929090; float:right;  text-decoration: none; cursor:pointer; margin-right:45px; font-size:14px; font-family:'Cairo';">إجازة 1</a><br>
                  <a class="side-link" href="#" style="color:#929090; float:right; text-decoration: none; cursor:pointer; margin-right:45px; font-size:14px; font-family:'Cairo';">إجازة 2</a>
                </div>
            </div>
            <div lang="ar" dir="rtl">
            <button id="btn1" class="accordion" lang="ar" dir="rtl"><i class="fas fa-star" style="font-size:18px; margin-right: 25px;"></i><span style="margin-right:10px; font-size:16px; font-family:'Cairo';">التقييمات</span></button>
                <div class="panel">
                  <a class="side-link" href="#" style="color:#929090; float:right;  text-decoration: none; cursor:pointer; margin-right:45px; font-size:14px; font-family:'Cairo';">تقييم 1</a><br>
                  <a class="side-link" href="#" style="color:#929090; float:right; text-decoration: none; cursor:pointer; margin-right:45px; font-size:14px; font-family:'Cairo';">تقييم 2</a>
                </div>
            </div>
            <div lang="ar" dir="rtl">
            <button id="btn1" class="accordion" lang="ar" dir="rtl"><i class="fas fa-file-alt" style="font-size:18px; margin-right: 25px;"></i><span style="margin-right:10px; font-size:16px; font-family:'Cairo';">التقارير</span></button>
                <div class="panel">
                  <a class="side-link" href="#" style="color:#929090; float:right;  text-decoration: none; cursor:pointer; margin-right:45px; font-size:14px; font-family:'Cairo';">تقرير 1</a><br>
                  <a class="side-link" href="#" style="color:#929090; float:right; text-decoration: none; cursor:pointer; margin-right:45px; font-size:14px; font-family:'Cairo';">تقرير 2</a>
                </div>
            </div>
            <div lang="ar" dir="rtl">
            <button id="btn1" class="accordion1" lang="ar" dir="rtl"><i class="fas fa-share-alt" style="font-size:18px; margin-right: 25px;"></i><span style="margin-right:10px; font-size:16px; font-family:'Cairo';">انصح مدرس بالتطبيق</span></button>
             ...
             <div lang="ar" dir="rtl">
            <button id="btn1" class="accordion1" lang="ar" dir="rtl"><i class="fas fa-sign-out-alt" style="font-size:18px; margin-right: 25px;"></i><span style="margin-right:10px; font-size:16px; font-family:'Cairo';">تسجيل خروج</span></button>
    ...
    -webkit-text-fill-color: transparent;">0004</h1>
