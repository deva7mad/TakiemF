 ...
 <nav>
    ...
    <main>
        <div class="row">
             ...
             <h1 lang="ar" dir="rtl"  style=" margin-left:250px;text-align:right;
              background: -webkit-linear-gradient(#47928b,#47948a,#48948a);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent; font-family:'Cairo'; font-size:20px;">التقييمات</h1>
             </div>
             <div class="t2" style="float:left;">
              <button  id="myBtn2" class="add-button" style="float: right;">أضف تقييم جديد</button>
             </div>
   ...
   <div class="modal-content">
        ...
        <div class="form-model">
			<div>
              <label lang="ar" dir="rtl" style="color:#8e8e8e; float:right; margin-right:50px;">اسم الفترة</label>
<select class="round" id="div-toggle" data-target=".my-info-1" style="width:98%; height:58px; border-radius:25px; font-size:15px; margin-bottom:20px;"  lang="ar" dir="rtl">
                ...
                <option value="lemon" data-show=".file">نسبة عددية </option>
                <option value="apple" data-show=".code">تقييم نصى </option>
                
            </select>
			</div>
			<div class="file hide">
              <label lang="ar" dir="rtl" style="color:#8e8e8e; float:right; margin-right:50px;">من </label>
              <input type="text" dir="rtl" lang="ar" placeholder="1"  name="reciver" style="border:1px solid  #f2f2f2;"required>
				<!--<i class="far fa-clock" style="float:left;"></i>-->
			</div>
			<div class="file hide">
              <label lang="ar" dir="rtl" style="color:#8e8e8e;float:right; margin-right:50px;">إلى </label>
              <input type="text" dir="rtl" lang="ar" placeholder="10"  name="reciver" style="border:1px solid #f2f2f2;" required>
				<!--<i class="far fa-clock" style="float:left;"></i>-->
			</div>
			<div class="code hide">
              <label lang="ar" dir="rtl" style="color:#8e8e8e; float:right; margin-right:50px;">التقييم الاول </label>
              <input type="text" dir="rtl" lang="ar" placeholder="متفوق"  name="reciver" style="border:1px solid  #f2f2f2;"required>
				<!--<i class="far fa-clock" style="float:left;"></i>-->
			</div>
			<div class="code hide">
              <label lang="ar" dir="rtl" style="color:#8e8e8e; float:right; margin-right:50px;">التقييم الثانى </label>
              <input type="text" dir="rtl" lang="ar" placeholder="غائب"  name="reciver" style="border:1px solid  #f2f2f2;"required>
				<!--<i class="far fa-clock" style="float:left;"></i>-->
			</div>
			<div class="code hide">
              <label lang="ar" dir="rtl" style="color:#8e8e8e; float:right; margin-right:50px;">التقييم الثالث</label>
              <input type="text" dir="rtl" lang="ar" placeholder="لم يقيم"  name="reciver" style="border:1px solid  #f2f2f2;"required>
				<!--<i class="far fa-clock" style="float:left;"></i>-->
			</div>
		<div>
    ...
    <table lang="ar" dir="rtl" class="roundtable">
    ...
    <tr>
        ...
        <td ><i class="fas fa-edit" style="color:#85b9f3;"></i></td>
        <td ><i class="fas fa-times" style="color:#ef6968;"></i></td>
