          ...
          <div class="panel panel-default">
            <div class="panel-heading" style="text-align:right; background-color:#e4f3f0 ! important; ">
              <a data-toggle="collapse" href="#collapse1" style="text-align:right; decoration:none; color:#4ea69a;"><h4 class="panel-title">
                ابتدائية أجيال اليرموك الاهلية
              </h4></a>
              ...
              <div class="panel-body">
                <div style="width:100%; height:50px;">
                  ...
                  <div class="dropdown pull-right" dir="rtl">
                    ...
                    <br>
                    <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" dir="rtl" style="border-color: black;background-color:white; color:black; width:340px;">الرياض
                      ...
                      <div class="dropdown pull-right" dir="rtl" style="margin-right:70px; ">
                        ...
                        <br>
                        <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" dir="rtl" style="border-color: black;background-color:white; color:black;  width:340px;">بنين
                ...
                <div style="width:100%; height:50px;">
                  ...
                  <div class="dropdown pull-right" dir="rtl">
                    ...
                    <br>
                    <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" dir="rtl" style="border-color: black;background-color:white; color:black;  width:340px;">الادارة التعليمية للتعليم بمنطقة الرياض
                      ...
                      <div class="dropdown pull-right" dir="rtl" style="margin-right:70px; ">
                        ...
                        <br>
                        <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" dir="rtl" style="border-color: black;background-color:white; color:black;  width:340px;">اهلى
                          <span class="caret" dir="rtl" style="color:black; margin-right:260px;"></span></button>
                            <ul class="dropdown-menu" dir="rtl">
                              <li><a href="#">اهلى</a></li>
                              <li><a href="#">اهلى</a></li>
                ...
                <div style="width:100%; height:50px;">
                  ...
                  <div class="dropdown pull-right" dir="rtl">
                    <label>المرحلة</label>
                    <br>
                    <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" dir="rtl" style="border-color: black;background-color:white; color:black;  width:340px;">ابتدائى
                      ...
                      <div class="dropdown pull-right" dir="rtl" style="margin-right:70px; ">
                        ...
                        <br>
                        <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown" dir="rtl" style="border-color: black;background-color:white; color:black;  width:340px;">ابتدائية اجيال اليرموك الاهلية
