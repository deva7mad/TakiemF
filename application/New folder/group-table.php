        ...
        <div class="data-container">
            <div class="t1" style="float:right;">
                <h1 lang="ar" dir="rtl"  style=" font-size:20px; text-align:right;background: -webkit-linear-gradient(#47928b,#47948a,#48948a);
                    -webkit-background-clip: text;-webkit-text-fill-color: transparent; ">التقارير</h1>
             </div>
             <div id="buttons" style="float:left;">
                 <button  id="myBtn0" class="add-button" style="float: right;">إنشاء تقرير طالب</button>
                 <button  id="myBtn1" class="changebtn" style="float: left;">إنشاء تقرير فصل</button>

             </div>
        </div>
        <table>
              <th>مراسلة ولى الامر</th>
               <th> ملاحظات</th>
            <th>سجل الطلاب <i class="fas fa-cog"></i> <i class="fas fa-arrow-alt-circle-left"></i> <i class="fas fa-plus-circle"></i></th>

              <tr>
				<td>01.حسن بن احمد حسن</td>
				<td><button>مراسلة</button></td>
			  </tr>
			  <tr>
				<td>02.بدربن محمد بن عبد الله</td>
				<td><button>مراسلة</button></td>
			  </tr>
			  <tr>
				<td>03.زياد رجب عبد الله الزهرانى</td>
				<td><button>مراسلة</button></td>
			  </tr>
			  <tr>
				<td>04.سعود عبد العزيز يحى حسن</td>
				<td><button>مراسلة</button></td>
			  </tr>
			  <tr>
				<td>05.نواف منصور نواف الحربى </td>
				<td><button>مراسلة</button></td>
			  </tr>
			  <tr>
				<td>06.مهنى مهيد مهناء السبيعى</td>
				<td><button>مراسلة</button></td>
			  </tr>
			  <tr>
				<td>07.سلطان متعب مهناء السبيعى</td>
				<td><button>مراسلة</button></td>
			  </tr>
			  <tr>
				<td>08.زياد رجب عبد الله الزهرانى</td>
				<td><button>مراسلة</button></td>
			  </tr>
			  <tr>
				<td>09.بدر بن محمد عبد الله</td>
				<td><button>مراسلة</button></td>
			  </tr>
