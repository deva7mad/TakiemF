...
<body>
   <nav>
    ...
    <main>
        ...
        <div style="text-align:center;   margin-left:8%; ">
                <img src="no-plans.png" width=350 height=250 />
        </div>
   ...
   <div id="myModal" class="modal">
    ...
    <div class="modal-content">
        ...
        -webkit-text-fill-color: transparent; ">اضافة خطة جديدة</h3>
        </div>
        <div class="form-model">

          <div>
              <label lang="ar" dir="rtl" style="float:right; margin-right:50px; color:#8e8e8e;">اسم الخطة</label>
