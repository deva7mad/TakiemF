...
select.round {
  ...
  background-position:
    calc(100% - 350px) calc(1em + 11px),
    calc(100% - 346px) calc(1em + 11px),
    calc(100% - .5em) .5em;
  background-size:
    4px 5px,
    4px 4px,
...
<body>
   <nav>
    ...
    <main>
        <div class="row">
        <div class="new-content" style="float:right;">
            <p lang="ar" dir="rtl">
                 ابتدايئة اجيال يرموك الاهلية / اول / ا رياضيات
            </p>
        </div>
        <br>
        <div style="text-align:center;  margin-left:40% ">
                <img src="new-group.png" width=350 height=250 />
        </div>
        <div  style="width:300px;  margin-left:45%;">
        <button lang="ar" dir="rtl" id="myBtn">
        اضف طالب جديد
        </button>
                </div>
        </div>
   <div id="myModal" class="modal">
    ...
    <div class="modal-content">
        ...
        -webkit-text-fill-color: transparent; ">إضافة مجموعة جديدة</h3>
        </div>
        <div class="form-model">
           <div>
            <label lang="ar" dir="rtl" style="float:right; margin-right:50px; color:#8e8e8e;">الطريقة</label>
            <select class="round" id="div-toggle" data-target=".my-info-1" style="width:98%; height:58px; border-radius:25px; font-size:15px; margin-bottom:20px;"  lang="ar" dir="rtl">
                <option value="orange" data-show=".manual">يدويا</option>
                <option value="lemon" data-show=".file">ملف مايكروسوفت اكسل</option>
                <option value="apple" data-show=".code">كود</option>
                <option value="pear" data-show=".group"> مجموعة موجودة مسبقا</option>
            </select>
          </div>
          <div class="my-info-1">
           <div class="manual">
            <label lang="ar" dir="rtl" style="float:right; margin-right:50px; color:#8e8e8e;">الاسم</label>
            <input type="text" dir="rtl" lang="ar" placeholder="" name="reciver" style="border:1px solid #c7c7c7;"required>
        </div>

            <div class="file hide">
                <label lang="ar" dir="rtl" style="float:right; margin-right:50px; color:#8e8e8e;">اضف الملف</label>
                <input type="text" dir="rtl" lang="ar" placeholder="" name="reciver" style="border:1px solid #c7c7c7;" required>
            </div>
            <div class="code hide">
                <label lang="ar" dir="rtl" style="float:right; margin-right:50px; color:#8e8e8e;">ادخل الكود</label>
                <input type="text" dir="rtl" lang="ar" placeholder="" name="reciver" style="border:1px solid #c7c7c7;" required>
                </div>
			...
			<label lang="ar" dir="rtl" style="float:right; margin-right:50px; color:#8e8e8e;">اضف الملف</label>
			<br>
			<!--<div style="width:397px; height:100px; background:green;">
			<label>One
...
<script>
// Get the modal
var modal1 = document.getElementById('myModalSide');

// Get the button that opens the modal
var btn1 = document.getElementById("btnSide");
