...
.modal-content {
    ...
    width: 30%;
    height:auto;
    border-radius:25px; /* Could be more or less, depending on screen size */
}
...
<body>
    ...
    <main>
        ...
        <div style="text-align:center;  margin-left:13%;">
                <img src="no-groups.png" width=350 height=250 />
        </div>
        <div  style="width:300px;  margin-left:44%;">
   ...
   <div id="myModal" class="modal">
    ...
    <div class="modal-content">
        ...
        <div class="form-model">
          ...
          <div>
              <label lang="ar" dir="rtl" style="float:right; margin-right:50px; color:#b0b0b0;">اسم المدرسة</label>
              <select class="round" style="width:95%; height:58px; border-radius:25px; font-size:15px; margin-bottom:20px;"  lang="ar" dir="rtl">
                <option >ابتدائية اجيال اليرموك الاهلية </option>
                <option >ابتدائية اجيال اليرموك الاهلية </option>
                <option >ابتدائية اجيال اليرموك الاهلية </option>
          ...
          <div>
                            <label lang="ar" dir="rtl" style="float:right; margin-right:50px;  color:#b0b0b0;">الصف</label>
                            <select class="round" style="width:95%; height:58px; border-radius:25px; font-size:15px; margin-bottom:20px;"  lang="ar" dir="rtl">
                                <option >اول</option>
                                 <option >اول</option>
                                  <option >اول</option>
                    ...
                    <div>
                            <label lang="ar" dir="rtl" style="float:right; margin-right:50px;  color:#b0b0b0;">الفصل</label>
                            <select class="round" style="width:95%; height:58px; border-radius:25px; font-size:15px; margin-bottom:20px;"  lang="ar" dir="rtl">
                                <option >أ</option>
                                <option >أ</option>
                                <option >أ</option>
                    ...
                    <div>
                            <label lang="ar" dir="rtl"style="float:right; margin-right:50px;  color:#b0b0b0;">المادة</label>
                            <select class="round" style="width:95%; height:58px; border-radius:25px; font-size:15px; margin-bottom:20px;"  lang="ar" dir="rtl">
        ...
        <div>
            <button lang="ar" dir="rtl" style="width=96% ! important;">
                  إضافة
            </button>
        </div>
        </div>
