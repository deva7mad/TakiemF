...
<body>
 <nav>
    ...
    <main>
        <div class="row">
             ...
             <h1 lang="ar" dir="rtl"  style=" margin-left:250px;text-align:right;
              background: -webkit-linear-gradient(#47928b,#47948a,#48948a);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent; font-family:'Cairo'; font-size:20px;">الأجازات</h1>
             </div>
             <div class="t2" style="float:left;">
              <button  id="myBtn2" class="add-button" style="float: right;">أضف أجازة جديدة</button>
             </div>
    ...
    <tr style="border-radius:25px;">
        ...
        <th style="width:30% text-align:right;">اسم الاجازة</th>
         <th style="width:20% text-align:right;">من</th>
         <th style="width:20% text-align:right;">الى</th>
        <th>تعديل</th>
         <th>حذف</th>
    </tr>
    <tr>
