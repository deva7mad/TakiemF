   ...
   <nav>
    ...
    -webkit-text-fill-color: transparent; ">بيانات الحساب</h1>
             <div class="account-data">
                ...
                <input type="text"  dir="rtl" lang="ar"  name= "teacher_name" value="<?php echo set_value('teacher_name'); ?>" required>
                </div>
                ...
                <input type="text"  dir="rtl" lang="ar" name="teacher_email" value="<?php echo set_value('teacher_email'); ?>" required>
                 </div>
                ...
                <input type="text" dir="rtl" lang="ar"  name="teacher_phone" value="<?php echo set_value('teacher_phone'); ?>" required>
                </div>
                ...
                <input type="password"  dir="rtl" lang="ar"  value="************" name="password" required>
                </div>
        ...
        <div class="change">
                <a href="#" dir="rtl" lang="ar" style=" font-family:'Cairo';color:red;position:absolute; top:37%;
                left:100px;">تغيير كلمة المرور</a>
            </div>
