...
<body>
   <nav>
	...
	<div class="row">
        ...
        <button  id="myBtn" class="add-button" style="float:right;">إنشاء تقرير فصل</button>
        <button class="delete-button" style="float:left;">إنشاء تقرير طالب</button>
    </div>
        </div>
        <table>
            <th>طباعة</th>
            ...
            <th> م </th>
              ...
              <tr>
                  <td><i class="fas fa-print" style="color:#f7595a;"></i></td>
                  <td><i class="fas fa-download" style="color:#6299dc;"></i></td>
                  <td><i class="fas fa-paper-plane" style="color:#66b6ab;"></i></td>
                  <td>الاثنين 2018/07/16</td>
                  <td>تقرير الطالب بدر بن محمد بن عبد الله</td>
                  <td>طالب</td>
                  <td>1</td>
                </tr>
                <tr>
