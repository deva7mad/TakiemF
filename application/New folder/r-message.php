...
<body>
   <nav>
	...
	<div class="row">
             ...
             <h1 lang="ar" dir="rtl"  style=" font-size:20px;
			 text-align:right;
              background: -webkit-linear-gradient(#47928b,#47948a,#48948a);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent; ">الرسائل الجاهزة</h1>
             </div>
             <div class="t2" style="float:left;">
              <button  id="myBtn" class="add-button" style="float: right;">إنشاء رسالة جديدة</button>
             </div>
