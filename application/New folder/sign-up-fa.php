...
<body>
    ...
    <div class="buttons" align="center">
        <button type="button" class="ovalbutton" dir="rtl" lang="ar" style="width:48%; float:right;" >حساب المدرس</button>
        <button type="button"  dir="rtl" lang="ar" style="width:48%; float:left;">حساب ولى الامر</button>
    </div>
