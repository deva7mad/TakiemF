   ...
   <nav>
        ...
        <div class="data-container">
            <div class="t1" style="float:right;">
                <h1 lang="ar" dir="rtl"  style=" font-size:20px; text-align:right;background: -webkit-linear-gradient(#47928b,#47948a,#48948a);
                    -webkit-background-clip: text;-webkit-text-fill-color: transparent; ">جدول الحصص</h1>
             </div>
    ...
    <div class="modal-content">
        ...
        <div class="form-model">
			<div>
              <label lang="ar" dir="rtl" style="color:#8e8e8e; float:right; margin-right:50px;">نص الرسالة </label>
		...
		<div>
            ...
            <th><div id="addnewperiod" style="background:#f3d02e; color:white; border:1px solid white; border-radius:50px; height:50px; width:50px; margin:0 auto; cursor:pointer;"><i class="fas fa-plus" style="    margin-top: 14px;
    margin-right: 14px;
    font-size: 25px;"></i></div></th>
             <th>السابعة<br> 11:30<br> 12:15</th>
             <th>السادسة<br> 10:50<br> 11:30</th>
             <th>الخامسة<br> 10:10<br> 10:50</th>
              <th>الرابعة<br> 09:15<br>09:55</th>
              <th>الثالثة<br> 08:35<br> 09:15</th>
              <th>الثانية<br> 07:30<br> 08:15</th>
               <th>الاولى<br> 06:45<br> 07:30</th>
            <th> من  الى </th>

              <tr>
                   <td></td>
                  <td style="background:#dbf7ce;">علوم<br> ثانى ب</td>
                  <td style="background:#d2f1ec;">رياضيات<br> اول ا</td>
                  <td></td>
                  <td style="background:#d2f1ec;">رياضيات <br>اول ج</td>
                  <td style="background:#d2f1ec;">رياضيات <br>اول ب</td>
                  <td></td>
                  <td style="background:#ffe6e7;">علوم <br>خامس ج</td>
                  <td>الاحد</td>
              ...
              <tr>
                ...
                <td></td>
                <td></td>
                <td style="background:#fff5c7;">علوم<br> اول ج</td>
                <td>الثلاثاء</td>
              </tr>
              <tr>
                <td></td>
              ...
              <tr>
                <td></td>
                <td style="background:#dbf7ce;">علوم <br>ثانى أ</td>
                <td></td>
                <td></td>
                <td></td>
                <td></td>
                <td style="background:#d2f1ec;">رياضيات <br>اول أ</td>
                <td style="background:#fff5c7;">علوم<br> اول ج</td>
                <td>الخميس </td>
              </tr>
