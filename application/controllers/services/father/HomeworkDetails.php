...
class homeworkdetails extends REST_Controller
{
  ...
  public function index_get()
    {
          $id = $this->get('homework_id');
          $homework_data[0] = $this->MainModel->getwhere('homework','homework_id',$id,'homework_id ASC');
          if(!empty($homework_data[0])){
            $data = json_decode ("{}");
            $done = array("status"=>"1","msg"=>"بيانات الواجبات","data"=>$homework_data[0]);
