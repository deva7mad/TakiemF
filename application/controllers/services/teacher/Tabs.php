...
class tabs extends REST_Controller
{
  ...
  public function index_get()
    {
        ...
        $this->set_response(array("status"=>"1","msg"=>"جميع التبويبات لدى هذا المعلم","data"=>array('tabs'=>$tabs)), REST_Controller::HTTP_OK);
            ...
            if ($this->form_validation->run() == FALSE)
                {
                  ...
                  $this->set_response($done, REST_Controller::HTTP_OK);
                       ...
                       $result = array(
                            'tab_main_name' => $this->post('tab_main_name'),
