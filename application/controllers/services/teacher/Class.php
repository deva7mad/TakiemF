            ...
            if ($this->form_validation->run() == FALSE)
                {
                  ...
                  $insert_id = $this->db->insert_id();
                   ...
                   if($inserdb){
                     $period = $this->MainModel->getwhere('period','period_id',$insert_id,'period_id ASC')[0];
                     $this->set_response(array("status"=>"1","msg"=>"تم إضافة الفترة بنجاح","data"=>$period), REST_Controller::HTTP_OK);
