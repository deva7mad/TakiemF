...
class readydelete extends REST_Controller
{
            ...
            if ($this->form_validation->run() == FALSE)
                ...
                //  $data = json_decode ("{}");
                  ...
                  $this->set_response($done, REST_Controller::HTTP_OK);
                   ...
                   $delete = $this->MainModel->destroy('notification_teacher','notif_id',$this->post('notif_id')) ;
                if($delete){
                  $this->set_response(array("status"=>"1","msg"=>"تم المسح بنجاح","data"=>null), REST_Controller::HTTP_OK);
               }else{
                  // $data = json_decode ("{}");
