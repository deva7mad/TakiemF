...
class InboxMessage extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->load->view('cpanel/parent/notification/message-inbox',$data);
      ...
      if($this->input->post()){
            ...
            $config = array(
              ...
              array(
                ...
                $this->load->view('cpanel/parent/notification/notifications',$data);
    }
  }
