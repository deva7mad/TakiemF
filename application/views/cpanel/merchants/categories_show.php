         ...
         if(isset($merchant_categories) AND !empty($merchant_categories)){
            foreach($merchant_categories as $key=>$value){
                ...
                <tr>
                  ...
                  <td>
                             <a href="<?= base_url().'admin/Merchant_category/modify/'.$value['mtype_token'] ?>" class="btn btn-info btn-icon  btn-sm m-r-xs m-b-xs"><i class="fa fa-edit"></i><span>Edit</span></a>
