  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="<?= base_url().'admin/Home'; ?>"><i class="fa fa-link"></i> <span>Home</span></a></li>
      ...
      <li class="treeview <?php if($this->uri->segment(2) == 'Customers' ){echo 'active';} ?>">
        ...
        <li class="treeview <?php if($this->uri->segment(2) == 'Merchant' OR  $this->uri->segment(2) == 'Merchant_category' ){echo 'active';} ?>">
          ...
          <ul class="treeview-menu" >
            <li> <a href="<?= base_url().'admin/Merchants' ?>"><i class="fa fa-circle-o "></i> Manage Merchants</a></li>
            <li> <a href="<?= base_url().'admin/Merchants/create' ?>"><i class="fa fa fa-circle-o "></i> New Merchants</a></li>
             <li> <a href="<?= base_url().'admin/Merchant_category' ?>"><i class="fa fa fa-circle-o "></i> Manage Merchants categories</a></li>
              <li> <a href="<?= base_url().'admin/Merchant_category/create' ?>"><i class="fa fa fa-circle-o"></i> New Merchants Category</a></li>
          </ul>
        </li>
          ...
          <ul class="treeview-menu" >
            <li> <a href="<?= base_url().'admin/Offerswallet' ?>"><i class="fa fa-circle-o "></i> Mange Offers Wallet </a></li>
            <li> <a href="<?= base_url().'admin/Offerswallet/create' ?>"><i class="fa fa fa-circle-o "></i> New Offers Wallet</a></li>
            <li> <a href="<?= base_url().'admin/Offersdiscount' ?>"><i class="fa fa-circle-o "></i> Mange Offers Discount </a></li>
            <li> <a href="<?= base_url().'admin/Offersdiscount/create' ?>"><i class="fa fa fa-circle-o "></i> New Offers Discount</a></li>
          </ul>
        </li>
