   ...
   <nav>
	...
	<div class="row">
      ...
      if(isset($error)){
        ...
        elseif (isset($done)) {
          echo '<div class="error">'.$done.'</div>';
        }
      ?>
        <button class="accordion2"><span class="school-span">ابتدائية اجيال اليرموك الاهلية </span></button>
		<div class="panel2">
			<div class="onerow">
				<div class="select-class" style="float:right;">
				...
				<div class="select-class" style="float:left;">
					<label>قطاع التعليم</label><br>
					<select>
						<option>option1</option>
						<option>option2</option>
						<option>option3</option>
