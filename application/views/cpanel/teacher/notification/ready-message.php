...
<body>
 <nav>
    ...
    <main>
        <div class="row">
             ...
             <h1 lang="ar" dir="rtl"  style=" margin-left:250px;text-align:right;
              background: -webkit-linear-gradient(#47928b,#47948a,#48948a);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent; font-family:'Cairo'; font-size:20px;">الرسائل الجاهزة</h1>
             </div>
             <div class="t2" style="float:left;">
              <button  id="myBtn2" class="add-button" style="float: right;">إنشاء رسالة جديدة</button>
             </div>
    ...
    <div class="modal-content">
        ...
        <div class="model-main">
            <h3 lang="ar" dir="rtl"  style="text-align:center;
                            background: -webkit-linear-gradient(#47928b,#47948a,#48948a);
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent; ">تعديل رسالة الجاهزة</h3>
        </div>
        <div class="form-model">

          <div>
              <label lang="ar" dir="rtl" style="float:right; margin-right:50px;">نص الرسالة </label>
        ...
        <div>
			...
			<button lang="ar" dir="rtl" class="delete-button-new">
                 حذف الرسالة
            </button>
        </div>
        </div>
    ...
    <tr style="border-radius:25px;">
        ...
        <th style="width:70% text-align:right;" >نص الرسالة</th>
        <th>تعديل</th>
         <th>حذف</th>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>ابنكم متفوق ما شاء الله , يستحق المكافاة</td>
        <td ><i class="fas fa-edit" style="color:#85b9f3;"></i></td>
        <td ><i class="fas fa-times" style="color:#ef6968;"></i></td>
    </tr>
    <tr>

        <td>شكرا لاهتمامكم بابنكم</td>
        <td ><i class="fas fa-edit" style="color:#85b9f3;"></i></td>
        <td ><i class="fas fa-times" style="color:#ef6968;"></i></td>
    </tr>
    <tr>

        <td>كل عام وانتم بخير عساكم من عواده</td>
       <td ><i class="fas fa-edit" style="color:#85b9f3;"></i></td>
        <td ><i class="fas fa-times" style="color:#ef6968;"></i></td>
    </tr>
</table>
