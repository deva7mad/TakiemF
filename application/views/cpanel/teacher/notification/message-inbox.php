...
select.round {
  ...
  background-position:
    calc(100% - 297px) calc(1em + 14px),
    calc(100% - 293px) calc(1em + 14px),
    calc(100% - .5em) .5em;
  background-size:
    4px 5px,
    4px 4px,
...
<body>
   <nav>
        <div class="nav-wrapper teacher">
            ...
            <div id="side-m" class="side-modal">
    ...
    <div class="modal-content-side" style="float:right; height:100%;">
            ...
            <button id="btn1" class="accordion1" lang="ar" dir="rtl"><i class="fas fa-sign-out-alt" style="font-size:18px; margin-right: 25px;"></i><span style="margin-right:10px; font-size:16px;">تسجيل خروج</span></button>
                ...
                <!--<div class="logo" dir="rtl" lang="ar" style="position:absolute;
                      left:83%; ">
                      <img src="logo-header.png"  height="100" width="250" style="margin-top:-13px;">
    ...
    background: -webkit-linear-gradient(#47928b,#47948a,#48948a);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent; ">الرسائل الواردة</h1>
        </div>
    <div class="main-buttons" style="float:left;" lang="ar" dir="rtl">
        <button  id="add-msg" class="add-button" style="float: right;">إنشاء رسالة جديدة</button>
        <button class="delete-button" style="float:left;">حذف جميع الرسائل</button>
    </div>

    </div>

     <div id="msg-model" class="modal">
    ...
    <div class="modal-content">
        ...
        <div>
            <label lang="ar" dir="rtl" style="float:right; margin-right:80px; margin-bottom:10px; color:#8e8e8e; font-size:12px; font-family:'Cairo';">المرسل اليه</label>
            <input type="text" dir="rtl" lang="ar" placeholder="" name="reciver" required>
        </div>
         <div >
              <label lang="ar" dir="rtl" style="float:right; margin-right:80px; margin-bottom:10px; color:#8e8e8e; font-size:12px; font-family:'Cairo';">نوع الرسالة </label>
  ...
  <option>No wrapper</option>
          ...
          <div>
            <label lang="ar" dir="rtl" style="float:right; margin-right:80px; margin-bottom:10px; color:#8e8e8e; font-size:12px; font-family:'Cairo';">نص الرسالة</label>
...
<div class="inbox-message" style="padding-top: 75px;
    margin-left: 10px;
       ...
       <div class="all" style="display:block; border:none; cursor:pointer; background:#f2f2f2; color:#939393; width: 98%; height:30px; border-radius:25px; margin-left: 37px; margin-bottom: 3px;">
           <div style="display:inline-block; float:right;">
               <i class="fas fa-user-circle" style="float:right; margin-right: 30px; font-size:14px; margin-top:8px;"></i>  <span style="float:left; margin-right:15px; font-size:13px; font-family:'Cairo'; margin-top: 3px;">فضلا استاذ اريد تقرير عن مادة العلوم لهذا الاسبوع</span>
           </div>
           <div style="display:inline-block; float:left; margin-left:20px;  margin-top: 3px;font-size:12px; font-family:'Cairo';">
               12:51 / 2018-07-16
           </div>
       </div>
       <div class="all" style="display:block; border:none; cursor:pointer; background:#f2f2f2; color:#939393; width: 98%; height:30px; border-radius:25px; margin-left: 37px; margin-bottom: 3px;">
       ...
       <div class="all" style="display:block; border:none; cursor:pointer; background:#fafafa; color:#939393; width: 98%; height:30px; border-radius:25px; margin-left: 37px; margin-bottom: 3px;">
           <div style="display:inline-block; float:right;">
               <i class="fas fa-user-circle" style="float:right; margin-right: 30px; font-size:14px; margin-top:8px;"></i>  <span style="float:left; margin-right:15px; font-size:13px; font-family:'Cairo';margin-top: 3px;">فضلا استاذ اريد تقرير عن مادة العلوم لهذا الاسبوع</span>
           </div>
           <div style="display:inline-block; float:left; margin-left:20px; margin-top: 3px; font-size:12px; font-family:'Cairo';">
...
<script>
// Get the modal
var modal1 = document.getElementById('msg-model');

// Get the button that opens the modal
var btn1 = document.getElementById("add-msg");
...
<script>
// Get the modal
var modal = document.getElementById('side-m');
