...
<body style="margin:0;">
   <nav>
    ...
    margin-top: 30px;
    font-size: 25px;">
ليس لديك اى رسائل صادرة ختى الان

              </div>
              <div  style="width:300px;  margin-left:40%;">
              <button lang="ar" dir="rtl" id="add-msg">
        إنشاء رسالة جديدة
              </button>
                      </div>
      </div>
     ...
     <div class="modal-content">
         ...
         <div>
             <label lang="ar" dir="rtl" style="float:right; margin-right:40px; margin-bottom:10px; color:#8e8e8e; font-size:14px; font-family:'Cairo';">المرسل اليه</label>
             <input type="text" dir="rtl" lang="ar" placeholder="" name="reciver" required>
         </div>
          <div >
               <label lang="ar" dir="rtl" style="float:right; margin-right:40px; margin-bottom:10px; color:#8e8e8e; font-size:14px; font-family:'Cairo';">نوع الرسالة </label>
               <select class="round" style="width:100%; height:48px; border-radius:25px; font-size:15px; margin-bottom:20px; margin-left:-14px;"  lang="ar" dir="rtl">
           ...
           <div>
             <label lang="ar" dir="rtl" style="float:right; margin-right:40px; margin-bottom:10px; color:#8e8e8e; font-size:14px; font-family:'Cairo';">نص الرسالة</label>
             <textarea dir="rtl" lang="ar" name="message" required></textarea>

         </div>
         <div>
             <button class="send-button" lang="ar" dir="rtl" style="margin-left:-10px;">
                   إرسال
             </button>
         </div>
         </div>
