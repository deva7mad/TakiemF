   ...
   <nav>
    ...
    -webkit-text-fill-color: transparent; ">بيانات الحساب</h1>
             <div class="account-data">
                ...
                <input type="text"  dir="rtl" lang="ar"  name= "teacher_name" value="<?php echo $teacher_name; ?>" required>
                </div>
                ...
                <input type="text"  dir="rtl" lang="ar" name="teacher_email" value="<?php echo $teacher_email; ?>" required>
                 </div>
                ...
                <input type="text" dir="rtl" lang="ar"  name="teacher_phone" value="<?php echo $teacher_phone; ?>" required>
                </div>
