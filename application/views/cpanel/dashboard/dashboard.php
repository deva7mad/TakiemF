         ...
         <div class="col-md-6">
              ...
              <div class="box box-danger">
                ...
                <div class="box-body no-padding">
                  ...
                  <?php
                  foreach($customers_last as $key=>$value){
                    ?>
                      <li>
                      <img src="<?= $value['customer_photo'] ?>" style="width: 80px;height: 80px;" alt="<?= $value['customer_name']  ?>"/>
                      <a class="users-list-name" href="#"><?= $value['customer_name']  ?></a>
                      <span class="users-list-date"><?= date('j-m-Y, g:i a',strtotime($value['customer_enterdate']))  ?></span>
                    </li>
                  <?php
                  }
                ...
                <div class="box-footer text-center">
                  <a href="<?= base_url().'admin/Customers'?>" class="uppercase">View All Customer</a>
                </div>
                <!-- /.box-footer -->
              </div>
              <!--/.box -->
            ...
            <div class="col-md-6">
              ...
              <div class="box box-danger">
                <div class="box-header with-border">
                  <h3 class="box-title">Latest Marchant</h3>

                  <div class="box-tools pull-right">
                    <span class="label label-danger">8 New Marchant</span>
                    <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                    </button>
                    <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i>
                    </button>
                ...
                <div class="box-body no-padding">
                  <ul class="users-list clearfix">
                      <?php 
					  if(!empty($merchant_last)){
                  foreach($merchant_last as $key=>$value){
                    ?>
                      <li>
                      <img src="<?= $value['merchant_photo'] ?>" style="width: 80px;height: 80px;" alt="<?= $value['merchant_name']  ?>"/>
                      <a class="users-list-name" href="#"><?= $value['merchant_name']  ?></a>
                      <span class="users-list-date"><?= date('j-m-Y, g:i a',strtotime($value['merchant_enterdate']))  ?></span>
                    </li>
                  <?php 
				  }}
                ...
                <!-- /.box-body -->
                <div class="box-footer text-center">
                  <a href="<?= base_url().'admin/Merchants'?>" class="uppercase">View All Marchant</a>
                </div>
                <!-- /.box-footer -->
              </div>
              <!--/.box -->
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB02SSxCkmyiWI2z4kQc0zTJXCAuOfXluc&libraries=places"></script>  
<script>
