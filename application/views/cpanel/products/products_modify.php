             ...
             <div class="box-body">
               ...
               <?php
                    ...
                    // khs_products `product_id`, `product_title`, `product_desc`, `product_token`, `product_status`, `product_category`, `product_photo`, `products_enter_date`
                     ...
                     echo form_open_multipart('admin/Products/modify/'.$product[0]['product_token'], $attributes);     
                    ?>
                    <div class="col-lg-6">
                           <div class="form-group">
                              <label for="exampleInputPassword1">Product Title</label>
                              <input type="text" class="form-control" value="<?php echo $product[0]['product_title']; ?>" name="product_title" id="text" placeholder="Product Title" />
                          </div>
                         <div class="form-group">
                                      <label for="exampleInputPassword1">Product Descipcation</label>
                                      <textarea class="form-control" name="product_desc" rows="3" placeholder="Enter ..."><?php echo $product[0]['product_desc']; ?></textarea>
                          </div>
                          <div class="form-group">
                                  <label>Product Status</label>
                                  <select class="form-control select2" name="product_status">
                                     <option value="no">Select status Product</option>
                                     <option <?php if($product[0]['product_status'] == 'active'){echo 'SELECTED';} ?> value="active">active</option>
                                     <option <?php if($product[0]['product_status'] == 'deactive'){echo 'SELECTED';} ?> value="deactive">deactive</option>
                   ...
                   <div class="col-lg-6">
                           ...
                           <div class="form-group row">
                              <label  for="imgInp">Product Photo </label>
                                ...
                                <img id="blah"  src="<?php echo base_url().$product[0]['product_photo']; ?>" width="250" height="250" class="img img-thumbnail img-responsive pull-right"/>
...
$("select option[value='<?=$product[0]['product_category'] ?>']").attr("selected","selected");
