...
// `merchant_area`, `merchant_tax_card`, `merchant_reg_commercial`, `merchant_enterdate` 
                     ...
                     echo form_open_multipart('admin/Merchants/create', $attributes);     
                    ?>
                    <div class="col-lg-6">
                           <div class="form-group">
                              <label for="exampleInputPassword1">Merchant Name</label>
                              <input type="text" class="form-control" value="<?php echo set_value('merchant_name'); ?>" name="merchant_name" id="text" placeholder="Merchant Name" />
                          </div>
                         <div class="form-group">
                                  <label for="exampleInputPassword1">Merchant Email</label>
                                  <input type="email"   class="form-control" value="<?php echo set_value('merchant_email'); ?>" name="merchant_email" id="text" placeholder="Merchant Email" />
                          
                           </div>
                          <div class="form-group">
                                  <label for="exampleInputPassword1">Merchant Password</label>
                                  <input type="password"   class="form-control" value="<?php echo set_value('merchant_password'); ?>" name="merchant_password" id="text" placeholder="Merchant Password" />
                           ...
                           <div class="form-group">
                                  ...
                                  <select class="form-control select2" name="merchant_city">
                           ...
                           <br />
                              <div class="form-group">
                                  ...
                                  <select class="form-control select2" name="merchant_area">
                         ...
                         <div class="form-group">
                              ...
                              <input type="text" class="form-control" value="<?php echo set_value('merchant_nummber'); ?>" name="merchant_nummber" id="text" placeholder="Merchant Nummber" />
                          </div>
                            <div class="form-group">
                              <label for="exampleInputPassword1">Merchant Tax Card Nummber (optional)</label>
                              <input type="text" class="form-control" value="<?php echo set_value('merchant_tax_card'); ?>" name="merchant_tax_card" id="text" placeholder="Merchant Tax Card Nummber " />
                          </div>
                            <div class="form-group">
                              <label for="exampleInputPassword1">Merchant Registration Commercial (optional)</label>
                              <input type="text" class="form-control" value="<?php echo set_value('merchant_reg_commercial'); ?>" name="merchant_reg_commercial" id="text" placeholder="Merchant Registration Commercial" />
                          </div>
                   ...
                   <div class="col-lg-6">
                         <div class="form-group">
                                  ...
                                  <select class="form-control select2" name="merchant_status">
                                     ...
                                     <option <?php echo set_select("merchant_status", "active") ?> value="active">active</option>
                                     <option  <?php echo set_select("merchant_status", "deactive") ?> value="deactive">deactive</option>
                                    
                                  </select>
                           </div>
                          <div class="form-group">
                                  <label>Merchant Type</label>
                                  <select class="form-control select2" name="merchant_type">
                        ...
                        <div class="form-group">
                                  ...
                                  <select class="form-control select2" name="merchant_delivery">
                                     ...
                                     <option <?php echo set_select("merchant_delivery", "yas") ?> value="yas">Yas</option>
                                     <option <?php echo set_select("merchant_delivery", "no") ?> value="no">No</option>
