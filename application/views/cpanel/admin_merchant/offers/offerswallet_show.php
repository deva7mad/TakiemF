            ...
            foreach($offers_wallet as $key=>$value){
                ...
                <td><?= $value['offers_wallet_id'] ?> </td>
                 ...
                 <!-- <td><?= $value['merchant_name'] ?></td>        -->
                  ...
                  <td>
                             <a href="<?= base_url().'admin_merchant/Offerswallet/modify/'.$value['offers_wallet_token'] ?>" class="btn btn-info btn-icon  btn-sm m-r-xs m-b-xs"><i class="fa fa-edit"></i><span>Edit</span></a>
