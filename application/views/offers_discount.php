...
&nbsp;</div>
  ...
  <div class="row">
   ...
   <?php
     if(!empty($offers_discount)) {
      foreach($offers_discount  as $value){       ?>

            <div class="col-md-6 col-sm-12 col-xs-12">
             <div class="block type-6 parallax-bg-text scroll-to-block" data-id="take-a-tour">
                    <h2 class="omar-tite"> <?=$value['offer_title'] ?></h2>
                    <h2 style="text-align:center"> <?=$value['offer_desc'] ?></h2>
            </div>

           <img src="<?=$value['offer_photo'] ?>"  alt="<?=$value['offer_title'] ?> "  class="img-responsive" alt="Responsive image" />
           </div>
       <?php } }?>
